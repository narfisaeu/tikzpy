...
class _canavas(object):
    ...
    :properties:
        * Get a group by unique id. (grp = pyTikZ.grp[id])
        * Set values to a group by the unique id. (pyTikZ.grp[id]=pto). The shape or point will be added.
    ...
    def addgroup(self, key):
        ...
        **Returns:**
        ...
        .. note::
            ...
            * See :doc:`groups examples </_examples/pytikZ_groups/test_gen>`.
