...
.. literalinclude:: /_examples/tikzpy_groups/test_pto_01_add_groups.py
    :linenos:
    :language: python

**This would output:**

.. include:: /_examples/tikzpy_groups/test_pto_01_add_groups.testout
   :literal:
...
See the following example:
    ...
    .. image:: test_pto_02_add_groups.tikz.png
       :width: 500px
       :align: center

Drawing created with the following tikzpy code:

.. literalinclude:: /_examples/tikzpy_groups/test_pto_02_add_groups.py
    :linenos:
    :language: python
...
See the following example:
    ...
    .. image:: test_pto_03_add_groups.tikz.png
       :width: 500px
       :align: center
