# -*- coding: utf-8 -*-
#
# tikzpy documentation build configuration file, created by
...
sub = os.path.abspath(os.path.join(grand_parent, "tikzpy"))
print sub
sys.path.insert(0, os.path.abspath(sub))
sys.path.insert(0, os.path.abspath(os.path.join(sub, "assemblies")))
...
project = u'tikzpy a python lib to draw TikZ pictures'
copyright = u'2014'
...
latex_documents = [
  ('index', 'tikzpy.tex', u'tikzpy Documentation',
   u'FLC', 'manual'),
]
...
man_pages = [
    ('index', 'tikzpy', u'tikzpy Documentation',
     [u'FLC'], 1)
]
...
texinfo_documents = [
  ('index', 'tikzpy', u'tikzpy Documentation',
   u'FLC', 'tikzpy', 'tikzpy documentation. Build your tikzpy drawing with python',
   'Miscellaneous'),
]
