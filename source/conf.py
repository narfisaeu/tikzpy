# -*- coding: utf-8 -*-
#
# pyTikZ documentation build configuration file, created by
...
sub = os.path.abspath(os.path.join(grand_parent, "pyTikZ"))
print sub
...
project = u'pyTikZ a python lib to draw TikZ pictures'
copyright = u'2014'
...
latex_documents = [
  ('index', 'pyTikZ.tex', u'pyTikZ Documentation',
   u'FLC', 'manual'),
]
...
man_pages = [
    ('index', 'pyTikZ', u'pyTikZ Documentation',
     [u'FLC'], 1)
]
...
texinfo_documents = [
  ('index', 'pyTikZ', u'pyTikZ Documentation',
   u'FLC', 'pyTikZ', 'pyTikZ documentation. Build your pyTikZ drawing with python',
   'Miscellaneous'),
]
