...
Load main **pyTikZ** class as follow and create points and shapes and add it to a group:
...
can be found in :doc:`groups examples </_examples/pytikZ_groups/test_gen>`.

Groups functions. Class -> pyTikZ.grp
-------------------------------------
