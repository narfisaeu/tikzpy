...
See the following example:
    ...
    .. image:: test_labels_01_add.tikz.png
       :width: 500px
       :align: center

Drawing created with the following tikzpy code:

.. literalinclude:: /_examples/tikzpy_labels/test_labels_01_add.py
    :linenos:
    :language: python
...
See the following example:
    ...
    .. image:: test_labels_02_add.tikz.png
       :width: 500px
       :align: center

Drawing created with the following tikzpy code:

.. literalinclude:: /_examples/tikzpy_labels/test_labels_02_add.py
    :linenos:
    :language: python
