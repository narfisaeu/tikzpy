...
How to use build-in plots **tikzpy.plots**
******************************************

Examples of how to use the shape objects :ref:`tikzpy.plots <py_tikz_plots_doc>`.
...
The build-in plot draws a racime plot.
    ...
    .. image:: test_plots_racime_1.tikz.png
       :width: 500px
       :align: center

Drawing created with the following tikzpy code:

.. literalinclude:: /_examples/tikzpy_plots/test_plots_racime_1.py
    :linenos:
    :language: python
...
The build-in plot draws a racime plot.
    ...
    .. image:: test_plots_racime_2.tikz.png
       :width: 500px
       :align: center

Drawing created with the following tikzpy code:

.. literalinclude:: /_examples/tikzpy_plots/test_plots_racime_2.py
    :linenos:
    :language: python
...
.. literalinclude:: /_examples/tikzpy_plots/test_plots_bars_vertical_1.py
    :linenos:
    :language: python
...
.. literalinclude:: /_examples/tikzpy_plots/test_plots_bars_vertical_2.py
    :linenos:
    :language: python
...
.. literalinclude:: /_examples/tikzpy_plots/test_plots_arrow_vertical_1.py
    :linenos:
    :language: python
